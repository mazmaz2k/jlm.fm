...
public class AboutD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.about_d);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_aboutD) {
            // startActivityForResult(new Intent(AboutD.this,About.class),1);
            //this.finish();
            return true;
            ...
            this.finish();
            startActivityForResult(new Intent(AboutD.this, MainActivity.class), 1);
            return true;
